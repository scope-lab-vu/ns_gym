...
In NS-Gym we can only update the "slipperiness" of the gridworld, which affects the probability of the agent's movement being altered to a different perpendicular direction.
