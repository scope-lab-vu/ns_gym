...
parser.add_argument('config_file_path', type=str, help='config yaml file')
args = parser.parse_args()
# config_file_path = "/media/--/home/n--/ns_gym/experiments/NS_Bridge/configs/MCTS_continous_config.yaml"

gym_config,wrapper_config,agent_config,exp_config = read_config_file(args.config_file_path)
...
def run_all_experiments(sample_id,q,seed,agent_config,wrapper_config,gym_config):
    ...
    try:
        ...
        num_mcts_simulations = agent_config["num_mcts_simulations"]
        max_mcts_search_depth = agent_config["mcts_depth"]
        action_space_dim = agent_config["action_size"]
        observation_space_dim = agent_config["state_size"]
        n_hidden_layers = agent_config["num_layers"]
        n_hidden_units = agent_config["num_units"]
        ...
        agent = nsb.benchmark_algorithms.AlphaZeroAgent(action_space_dim=action_space_dim,
        ...
        while not done and not truncated and count < max_episode_steps:
            ...
            action = agent.act(obs,env = planning_env)
        ...
        result = [sample_id,episode_reward,experiment_name,num_mcts_simulations,total_time,seed,realworld_env.P,count]
        q.put(result)
...
def main():
    ...
    with open(outfile, mode='w', newline='') as file:
        ...
        writer.writerow(["sample_id","reward","experiment_name","num_iter","total_time","seed","final_dist","num_steps"])
