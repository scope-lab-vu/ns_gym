...
def train_alpha_zero(config_file_path):
    ...
    env = nsb.wrappers.NSCliffWalkingWrapper(env,
    ...
    episode_rewards = alphazero_agent.train(env,
                          ...
                          temp_start=training_config["temp_start"],
                          temp_decay=training_config["temp_decay"],
                          temp_end=training_config["temp_end"]
                          )
...
if __name__ == "__main__":
    ...
    train_alpha_zero(args.config_file)
