...
def run_all_experiments(mass,sample_id,q,seed,agent_config,wrapper_config,gym_config):
    ...
    try:
        ...
        logger.info(f"FINISHED: Experiment with num_samples: {sample_id},seed: {seed},mass: {mass},reward: {episode_reward},time: {total_time}")
        result = [sample_id,mass,episode_reward,experiment_name,total_time,seed]
        q.put(result)
...
def main():
    ...
    with open(outfile, mode='w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(["sample_id","mass","reward","experiment_name","total_time","seed"])
