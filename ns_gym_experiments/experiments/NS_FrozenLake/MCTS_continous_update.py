...
def run_all_experiments(num_iter,c,gamma,sample_id,q,seed,agent_config,wrapper_config,gym_config):
    ...
    """
    try:
        logger.info(f"STARTING: Experiment with num_iter:{num_iter} num_samples: {sample_id},seed: {seed},c {c}, gamma {gamma}")
        ...
        while not done and not truncated and exp_steps < exp_config["max_experiment_steps"]:
