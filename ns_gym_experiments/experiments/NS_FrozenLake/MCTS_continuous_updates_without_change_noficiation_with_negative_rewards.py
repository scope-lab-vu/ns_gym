...
experiment_name = f"MCTS_ContinuousUpdate_withoutChangNotif_{formatted_date}"
...
def run_single_experiment(gamma, c, num_iter, sample_id,seed):
    ...
    while not done and not truncated:
        ...
        mcts_agent = nsb.benchmark_algorithms.MCTSv5(env=planning_env,state=obs.state,d=500, m=num_iter, c=c, gamma=gamma)
