...
"""
PAMCTS -- single discrete change in NS FrozenLake environment with change notification.
...
experiment_name = f"PAMCTS_single_discrete_change_withoutChangNotif_{formatted_date}"
...
def main():
    ...
    alpha = [0.0,0.25,0.5,0.75,1]
    gamma = [0.999]
    c = [np.sqrt(2)]
    num_iter = [25,50,100,500,1000,3000]
