...
config_file_path = "/media/--/home/n--/ns_gym/experiments/NS_Bridge/configs/DDQN_continous_config.yaml"
...
def run_all_experiments(sample_id,q,seed,agent_config,wrapper_config,gym_config):
    ...
    try:
        ...
        result = [sample_id,episode_reward,experiment_name,total_time,seed,realworld_env.P]
        q.put(result)
...
def main():
    ...
    with open(outfile, mode='w', newline='') as file:
        ...
        writer.writerow(["sample_id","reward","experiment_name","total_time","seed","final_dist"])
