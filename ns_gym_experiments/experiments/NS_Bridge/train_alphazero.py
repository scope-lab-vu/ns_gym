...
def train_alpha_zero(config_file_path):
    ...
    env = nsb.wrappers.NSBridgeWrapper(env,tunable_params=param)
...
if __name__ == "__main__":
    import os
    config_file_path = "/media/--/home/n--/ns_gym/experiments/NS_Bridge/configs/alphzero_training_config.yaml"
