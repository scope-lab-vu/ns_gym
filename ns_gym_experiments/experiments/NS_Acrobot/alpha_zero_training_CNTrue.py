...
def train_alpha_zero(config_file_path):
    ...
    updateFn = nsb.update_functions.NoUpdate(scheduler)
...
if __name__ == "__main__":
    import os
    # config_file_path = "alphazero_training.yaml"
    config_file_path = 'experiments/NS_Acrobot/alphazero_training.yaml'
